...
const App = function() {
  ...
  // ========== 七身份水墨国画符号（笔触晕染 SVG，非人物图；引用 index.html 共享 #inkRough/#inkPool） ==========
  const IDENTITY_MARKS = {
    youxia:`<svg viewBox="0 0 200 200" fill="none"><ellipse cx="96" cy="104" rx="62" ry="50" fill="url(#inkPool)"/><g filter="url(#inkRough)" fill="currentColor" stroke="none"><path d="M70 150 C58 118 70 92 98 80 C84 102 80 126 88 150 Z" opacity=".92"/><path d="M84 152 C94 120 124 102 156 98 C124 110 100 132 94 154 Z" opacity=".82"/><path d="M72 150 C70 126 86 110 112 102 C92 118 80 134 84 152 Z" opacity=".68"/></g><g filter="url(#inkRough)" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" fill="none" opacity=".5"><path d="M34 64 C88 54 132 50 172 44"/><path d="M44 82 C90 76 128 74 164 70" opacity=".34"/></g><g fill="currentColor" opacity=".5"><circle cx="156" cy="54" r="2"/><circle cx="168" cy="70" r="1.5"/><circle cx="140" cy="42" r="1.4"/><circle cx="150" cy="86" r="1.3"/></g></svg>`,
    shijia:`<svg viewBox="0 0 200 200" fill="none"><rect x="60" y="54" width="80" height="92" rx="12" fill="url(#inkPool)"/><rect x="60" y="54" width="80" height="92" rx="12" fill="none" stroke="currentColor" stroke-width="5" filter="url(#inkRough)"/><g filter="url(#inkRough)" stroke="currentColor" stroke-width="3" fill="none" stroke-linecap="round" opacity=".82"><path d="M80 92 H120"/><path d="M100 80 V116"/><path d="M80 116 H120"/><path d="M86 100 H114"/></g></svg>`,
    shuyuan:`<svg viewBox="0 0 200 200" fill="none"><rect x="56" y="58" width="88" height="84" fill="url(#inkPool)"/><rect x="56" y="58" width="88" height="6" rx="3" fill="currentColor" opacity=".82" filter="url(#inkRough)"/><rect x="56" y="128" width="88" height="6" rx="3" fill="currentColor" opacity=".82" filter="url(#inkRough)"/><g filter="url(#inkRough)" stroke="currentColor" stroke-width="1.6" opacity=".5"><path d="M74 70 V124"/><path d="M86 70 V124"/><path d="M98 70 V124"/><path d="M110 70 V124"/><path d="M122 70 V124"/></g></svg>`,
    yizhe:`<svg viewBox="0 0 200 200" fill="none"><ellipse cx="100" cy="148" rx="40" ry="24" fill="url(#inkPool)"/><g filter="url(#inkRough)" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round"><path d="M96 156 C84 118 92 92 122 74"/><path d="M96 156 C106 120 128 102 156 94"/><path d="M96 156 C88 128 78 110 66 98" opacity=".8"/><path d="M96 156 C102 132 120 118 138 114" opacity=".7"/></g><g fill="currentColor" opacity=".72"><circle cx="121" cy="74" r="3.2"/><circle cx="156" cy="94" r="2.6"/><circle cx="66" cy="98" r="2.2"/><circle cx="138" cy="114" r="2"/></g></svg>`,
    qinshi:`<svg viewBox="0 0 200 200" fill="none"><ellipse cx="100" cy="100" rx="64" ry="64" fill="url(#inkPool)"/><g filter="url(#inkRough)" fill="none" stroke="currentColor"><circle cx="100" cy="100" r="20" stroke-width="2.4" opacity=".82"/><circle cx="100" cy="100" r="40" stroke-width="2" opacity=".52"/><circle cx="100" cy="100" r="60" stroke-width="1.6" opacity=".32"/></g><path d="M40 100 H160" stroke="currentColor" stroke-width="2.4" opacity=".66" stroke-linecap="round" filter="url(#inkRough)"/><path d="M52 116 H148" stroke="currentColor" stroke-width="1.4" opacity=".34" stroke-linecap="round" filter="url(#inkRough)"/></svg>`,
    jianke:`<svg viewBox="0 0 200 200" fill="none"><ellipse cx="106" cy="100" rx="64" ry="22" fill="url(#inkPool)" transform="rotate(-32 106 100)"/><g filter="url(#inkRough)"><path d="M50 152 C92 116 128 82 162 46" fill="none" stroke="currentColor" stroke-width="9" stroke-linecap="round" opacity=".9"/><path d="M50 152 C92 116 128 82 162 46" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" opacity=".5"/></g><g fill="currentColor" opacity=".72"><circle cx="162" cy="46" r="3.2"/><circle cx="170" cy="38" r="2"/><circle cx="150" cy="60" r="1.7"/><circle cx="178" cy="52" r="1.4"/></g></svg>`,
    yinshi:`<svg viewBox="0 0 200 200" fill="none"><path d="M24 142 L68 92 L96 122 L130 80 L176 142 Z" fill="url(#inkPool)" filter="url(#inkRough)"/><path d="M44 142 L82 106 L112 130 L150 96 L184 142 Z" fill="currentColor" opacity=".5" filter="url(#inkRough)"/><path d="M24 142 H176" stroke="currentColor" stroke-width="1.4" opacity=".42"/><rect x="20" y="116" width="160" height="12" fill="#f3f0e9" opacity=".55"/></svg>`
  };
  ...
  function renderIdentitySelect(){
    ...
    JIANGHU_DATA.identities.forEach(id=>{
      ...
      node.innerHTML=`<span class="bloom"><span class="ink-motif">${IDENTITY_MARKS[id.id]||''}</span></span><i class="node-dot"></i>`
